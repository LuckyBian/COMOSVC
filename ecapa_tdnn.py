...
class ECAPA_TDNN(nn.Module):
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
        ...
        if config_path is None:
            ...
            self.feature_extract = torch.hub.load('wavlm/s3prl/s3prl-e52439edaeb1a443e82960e6401ae6ab4241def6', 'wavlm_large',path='wavlm/f2d5200177fd6a33b278b7b76b454f25cd8ee866d55c122e69fccf6c7467d37d.wavlm_large.pt',source='local')
